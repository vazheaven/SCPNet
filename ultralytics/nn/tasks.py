...
from ultralytics.SCPNet.CDSAM import CDSAM
from ultralytics.SCPNet.SFCAM import SFCAM
from ultralytics.SCPNet.SEM import SEM
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        #     c1 = ch[f]
        #     args = [c1, c2, *args[1:]]
        # elif m in {WindowAttention_ASSA,CAFM,CascadedGroupAttention,DeformableAttention,DySample,Fused_Fourier_Conv_Mixer,FSAS,Halo_Attention,HRAMi,TransformerBlock,
        #            VisionRetentionChunk,MultiFrequencyChannelAttention,MixStructureBlock,MLKA_Ablation,ABlock_MS_Attention_RepConv_qkv_id,EMCAD_block,MSFN,
        #            NonLocalBlockND,SHSA_BLOCK,SABlock,SEM}:
        elif m in {SEM}:
            c2 = ch[f]
            args =[ch[f]]
        # elif m is DICAM:
